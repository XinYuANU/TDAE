...
opt = lapp[[
  -s,--save          (default "logs128_ytc16_stn_D_decay_v6_noise_01")      subdirectory to save logs
...
local lowHd5 = hdf5.open('datasets/YTC_LR_rotate_v6_01.hdf5', 'r')
...
if opt.network == '' then
  ...
  model_G:add(cudnn.SpatialConvolution(3, 64, 5, 5, 1, 1, 2, 2))
  model_G:add(cudnn.ReLU(true))  
  model_G:add(cudnn.SpatialConvolution(64, 128, 3, 3, 1, 1, 1, 1))
  model_G:add(cudnn.ReLU(true))  
  
  model_G:add(cudnn.SpatialConvolution(128, 512, 3, 3, 1, 1, 1, 1))  
